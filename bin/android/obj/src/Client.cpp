...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(14)
	::sys::net::Host _g = ::sys::net::Host_obj::__new(HX_CSTRING("localhost"));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(14)
	s->connect(_g,(int)2000);
	HX_STACK_LINE(15)
	::sys::net::Address ad = ::sys::net::Address_obj::__new();		HX_STACK_VAR(ad,"ad");
	HX_STACK_LINE(17)
	::haxe::Log_obj::trace(ad->host,hx::SourceInfo(HX_CSTRING("Client.hx"),17,HX_CSTRING("Client"),HX_CSTRING("new")));
	HX_STACK_LINE(18)
	while((true)){
		HX_STACK_LINE(19)
		::String l = s->input->readLine();		HX_STACK_VAR(l,"l");
		HX_STACK_LINE(20)
		::haxe::Log_obj::trace(l,hx::SourceInfo(HX_CSTRING("Client.hx"),20,HX_CSTRING("Client"),HX_CSTRING("new")));
		HX_STACK_LINE(21)
