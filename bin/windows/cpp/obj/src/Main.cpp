...
{
HX_STACK_FRAME("Main","new",0x6616a5cb,"Main.new","Main.hx",43,0x087e5c05)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(44)
	super::__construct();
...
{
		HX_STACK_FRAME("Main","resize",0x39257969,"Main.resize","Main.hx",20,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(20)
		if ((!(this->inited))){
...
Void Main_obj::init( ){
{
		HX_STACK_FRAME("Main","init",0xea732345,"Main.init","Main.hx",25,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(26)
		if ((this->inited)){
			HX_STACK_LINE(26)
		...
		this->inited = true;
		HX_STACK_LINE(30)
		::Client client = ::Client_obj::__new();		HX_STACK_VAR(client,"client");
	}
return null();
}
...
{
		HX_STACK_FRAME("Main","added",0x98771aeb,"Main.added","Main.hx",49,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(50)
